...
<head>
    ...
    <title>422-Entité non traitable</title>
...
<body>
   ...
   <?php include_once __DIR__.'/../views/templates/navbar_error.php'?>
    ...
    <div class="col-lg-6 col-12 d-flex flex-column align-items-center justify-content-center">
          ...
          <img src="<?php echo ROOT_PATH ?>/app/errors/img/422.svg" alt="" class="img-fluid w-50 h-50">
            <h1 class="text-center display-4"><strong class="font-weight-bold">422</strong> Entité non traitable.</h1>
        </div>
    </div>
