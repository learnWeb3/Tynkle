...
<body>
   ...
   <?php include_once __DIR__.'/../views/templates/navbar_error.php'?>
    ...
    <div class="container-fluid d-flex align-items-center justify-content-center p-4 p-4" style="min-height: 100vh;background-image:(url(<?php echo ROOT_PATH ?>/app/errors/img/403.svg))">

    <div class="col-lg-6 col-12 d-flex flex-column align-items-center justify-content-center">
          
          <img src="<?php echo ROOT_PATH ?>/app/errors/img/403.svg" alt="" class="img-fluid w-50 h-50">
            <h1 class="text-center display-4"><strong class="font-weight-bold">403</strong> Accès interdit.</h1>
        </div>
