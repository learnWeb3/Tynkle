...
class Application
{
    ...
    public static function all(\PDO $connection, string $path, int $start = 0, int $limit = 10)
    {
        $table_name = self::getTableName(get_called_class());
    ...
    public static function searchByString(\PDO $connection, array $query_params, string $path, int $start = 0, int $limit = 10)
    {
