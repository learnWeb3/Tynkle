<header class="fixed-top" style='z-index:1200'>
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="#navbar">
        <div class="container-fluid">
            <a class="navbar-brand font-weight-bold" href="<?php echo ROOT_PATH . '/' ?>"><img src="<?php echo ABSOLUTE_ASSET_PATH ?>/icons/logo_tynkle.png" height="36" width="64" alt="Tynkle Logo">Tynkle Blog</a>
