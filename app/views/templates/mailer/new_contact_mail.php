                ...
                <tr>
                    <td class="esd-email-paddings" valign="top">
                        <table class="es-header esd-header-popover" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" align="center" bgcolor="#4Abded" style="background-color: #4abded;">
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="580" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p10r es-p10l" align="center" style="font-size:0"><a href target="_blank"><img src="https://ngglro.stripocdn.email/content/guids/CABINET_3df254a10a99df5e44cb27b842c2c69e/images/7331519201751184.png" alt style="display: block;" width="40"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" style="background-color: #4abded;" bgcolor="#4Abded" align="center">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p35t es-p5b es-p30r es-p30l" align="center">
                                                                                        <h1 class="text-center display-4">Nouveau contact !</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p style="font-size: 2rem;">Bonjour <strong><?php echo $user_firstname ?> <?php echo $user_lastname ?></strong> vous à envoyé le message suivant :</p>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td style="background-color: #e4e4e4;" class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p style="font-weight: bold;">Objet :</p>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td  style="background-color: #e4e4e4;" class="esd-block-text es-p10t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p><?php echo $message_subject ?></p>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td style="background-color: #e4e4e4;" class="esd-block-text es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p35t es-p35b es-p10r es-p10l" align="center"><span class="es-button-border" style="border-radius: 40px; background: #f3cf12;"><a href="mailto:<?php echo $user_email ?>" class="es-button" target="_blank" style="border-width: 15px 30px; border-radius: 40px; background: #f3cf12; border-color: #f3cf12;">répondre</a></span></td>
                                                                                </tr>
                                                                            
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left" esd-links-color="#4Abded"><a target="_blank" href="" style="color: #4abded;"></a></td>
                                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table style="background-color: #ffecd1; border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffecd1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30t es-p30r es-p30l" align="center" bgcolor="#4Abded">
                                                                                        <h3 style="color: #ffffff;">Partager Tynkle !</h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-social es-p10" style="font-size: 0px; background-color: #4abded;" bgcolor="#4Abded">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30b es-p30r es-p30l" esdev-links-color="#ffa73b" align="center" bgcolor="#4Abded" esd-links-color="#ffffff"><br></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="left">
                                                                                        <p><strong><a target="_blank" href="">Accueil</a> - <a target="_blank" href="<?php echo ABSOLUTE_REDIRECT_PATH."/posts" ?>">Les annonces</a> -</strong></p>
                                                                                    </td>
                                                                                </tr>
                                        
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p25t" align="left">
                                                                                        <p>Tynkle - Adesse siège social&nbsp;-&nbsp;Septèmes-les-Vallons - 13240</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
