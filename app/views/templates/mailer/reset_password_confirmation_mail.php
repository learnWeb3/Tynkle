                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p35t es-p5b es-p30r es-p30l" align="center">
                                                                                        <h1 class="text-center display-4">Mot de passe oublié</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p>Bonjour vous avez demandé à reinitialiser votre mot de passe, veuillez cliquer sur le lien ci dessous afin de le reinitialiser.<br>Si cette action ne vient pas de vous merci d'ignorer cet email et de modifier votre mot de passe dans les paramètre de votre compte pour des raisons de sécurité.<br><br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
