                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                        <p>Bonjour vous venez de créer un compte sur Tynkle, merci de confirmer cotre compte afin de finaliser votre inscription;</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p35t es-p35b es-p10r es-p10l" align="center"><span class="es-button-border" style="border-radius: 40px; background: #f3cf12;"><a href="<?php echo ABSOLUTE_REDIRECT_PATH."/users/".$user_id.'/confirm?verify_token='.$verify_token ?>" class="es-button" target="_blank" style="border-width: 15px 30px; border-radius: 40px; background: #f3cf12; border-color: #f3cf12;">confirmer </a></span></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Dans le cas ou le lien ne fonctionnerai pas veuillez copier-coller&nbsp;l'url suivante dans la barre d'adresse de votre navigateur :</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left" esd-links-color="#4Abded"><a target="_blank" href="<?php echo ABSOLUTE_REDIRECT_PATH."/users/".$user_id.'/confirm?verify_token='.$verify_token ?>" style="color: #4abded;"><?php echo ABSOLUTE_REDIRECT_PATH."/users/".$user_id.'/confirm?verify_token='.$verify_token ?></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p25t">
                                                                                        <p>Vous recevez ce mail suite à votre inscription sur la plateforme Tynkle.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
