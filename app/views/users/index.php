    ...
    <div class='d-flex' style="min-height: 100vh;width:100vw">
        <section class="d-none col-xl-3 d-xl-flex flex-column p-4 fixed-bottom" style="height:100vh;"
            ...
            <div class="container bg-white w-100 shadow p-4 d-block overflow-auto" style="margin-top: 15%;">
                <h4 class="font-weight-bold">Rechercher un helper:</h4>
                <hr>
        ...
        <section class="col-12 col-xl-8 offset-xl-3 d-flex flex-column justify-content-center align-items-center">
            <div class="card-columns col-12 p-4" id="users-container"
                ...
                <?php foreach ($users as $user): ?>
                    <?php include __DIR__.'/../static/_user_card.php'?>
                <?php endforeach;?>
            </div>
...
<script type="module" src="<?php echo ROOT_PATH . '/app/assets/js/users/users.js' ?> "></script>