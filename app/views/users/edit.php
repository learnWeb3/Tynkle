        ...
        <section style="min-height:95vh" class="w-100 d-flex align-items-center justify-content-center"
            ...
            <form action="<?php echo ROOT_PATH . '/users/' . $user['id'] ?>" class="col-12 col-lg-9 mb-4 p-4"
                ...
                <div class="form-group my-2">
                    ...
                    <input type="text" name="username" id="username" class="form-control" placeholder="prenom.nom"
                ...
                <div class="form-group my-2 d-flex col-12">
                    <div class="col-4">
                        ...
                        <label style="cursor: help;" data-placement="top" data-toggle="tooltip"
                            title="Vous pouvez également obtenir de l'aide de la communauté" .>Devenir également Helper
                            ?</label>
                        <?php else: ?>
                        <label style="cursor: help;" data-placement="top" data-toggle="tooltip"
                            title="Vous pouvez également partager vos compétences" .>Devenir également Helper ?</label>
                        <?php endif;?>
                    </div>
                    <div class="col-6">
        ...
        <section id="personnal_informations" class="w-100 d-flex  align-items-center justify-content-center"
            ...
            <form action="<?php echo ROOT_PATH . '/users/' . $user['id'] ?>" class="col-12 col-lg-9 my-4 p-4"
                ...
                <div class="form-group my-2">
                    ...
                    <input type="text" name="lastname" id="lastname" class="form-control" placeholder="Dupond"
                ...
                <div class="form-group my-2">
                    ...
                    <input type="text" name="phone_number" id="phone" class="form-control" placeholder="+33799999999"
