    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title front-weight-bold" id="warningLabel">SIGNALER L'UTILISATEUR</h5>
            ...
            <div class="modal-body d-block overflow-auto" style="min-height: 35vh">
                <form action="" data-idUser="<?php echo $user['id'] ?>" class="form-lg" method="post" id="warning-form">
                    ...
                    <div class="form-group my-2">
                        ...
                        <textarea required name="content" id="content" class="form-control" rows="10" placeholder="Je souhaite signaler cet utilisateur pour les raisons suivantes :"></textarea>
                    </div>
                </form>
            </div>
