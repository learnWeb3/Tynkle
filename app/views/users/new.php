<main class="d-flex flex-column justify-content-center bg-background"
    style='background-image: url(<?php echo $background_image_path ?>);min-height:100vh;'>

    <section class="col-12 col-xl-4 d-flex flex-column align-items-center justify-content-center p-6 rounded-3 bg-white"
        id='sign-container'>
        <form action="<?php echo ROOT_PATH . '/users' ?>" class="w-100 d-block overflow-auto" method="post">
            ...
            <div class="form-group my-2">
                <label for="username" style="cursor: help;" data-placement="top" data-toggle="tooltip"
                    title="Veuillez choisir un identifiant unique">Identifiant *</label>
                <input type="text" id="username" name="username" class="form-control" placeholder="Prenom94" required>
            </div>
            <div class="form-group my-2">
                <label for="email" style="cursor: help;" data-placement="top" data-toggle="tooltip"
                    title="Veuillez entrer une adresse email valide">Adresse email *</label>
                <input type="email" id="email" name="email" class="form-control" placeholder="prenom-nom@email.com"
                    required>
            </div>
            <div class="form-group my-2">
                <label for="password" style="cursor: help;" data-placement="top" data-toggle="tooltip"
                    title="Veuillez choisir un mot de passe d'une logueur minimum de 6 caractères">Mot de passe
                    *</label>
                <input type="password" class="form-control" id="password" name="password" required>
            </div>
            <div class="form-group my-2">
                <label for="password_confirmation" style="cursor: help;" data-placement="top" data-toggle="tooltip"
                    title="Les mots de passe doivent être identiques">Confirmer le mot de passe *</label>
            ...
            <div class="form-group my-2 d-flex col-12">
                ...
                <div class="col-6">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_helper" id="helper_role_2" value="0"
                            checked>
            ...
            <div class="form-group my-2 p-2">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="cgu_accepted">
                        Je reconnais avoir lu et accepté les <a class="text-brand-blue"
                            href="<?php echo ROOT_PATH.'/rules/1' ?>">Conditions Générales d‘Utilisation</a>, et je
                        confirme être âgé d’au moins 18 ans.
                    </label>
                </div>
            </div>
