<main style="background-image: url(<?php echo $background_image_path ?>);" class="bg-background">
    <section class="container-xl d-flex justify-content-start align-items-center bg-white p-4">
        <img data-aos="zoom-in" data-aos-duration="1000" src="<?php echo ABSOLUTE_ASSET_PATH . "/img/commons/contact.svg" ?>" class="img-fluid" style="max-height: 12rem;" alt="">
        <h1 data-aos="zoom-in" data-aos-duration="1000" class="font-weight-bold" style="cursor: help;" data-placement="top" data-toggle="tooltip" title="Dans le cas ou ce formulaire ne fonctionnerai pas vous pouvez nous contacter à contact@tynkle.com">Nous contacter <a href="mailto:contact@tynkle.com">@</a></h1>
