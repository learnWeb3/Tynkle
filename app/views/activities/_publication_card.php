    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6 d-flex align-items-center">
                <i class="lni lni-alarm-clock lni-16"></i>
                <small class="m-2 mb-0">Posté le <?php echo htmlspecialchars($post['created_at']) ?></small>
            </div>
            <div class="col-6 d-flex justify-content-end">
            <?php if ($post['user_id'] === $current_user): ?>
                    <a href="<?php echo ROOT_PATH . "/posts/" . $post['id'] . "/destroy" ?>"> <i class="lni lni-trash lni-16"></i></a>
                    <a href="<?php echo ROOT_PATH . "/posts/" . $post['id'] . "/edit" ?>"><i class="lni lni-spinner-arrow lni-16"></i></a>
                <?php endif;?>
            </div>
        </div>
